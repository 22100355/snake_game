...
module vga_sync_generator(
	...
	output reg [11:0] x_counter, // Öª??
	output reg [10:0] y_counter, // ú¼??
	output reg in_display_area // ãÀÜúî¤?ãÆ?æ´£¨x_counter<1920 && y_counter<1080)
	);
	  ...
	  if (x_counter_max)
		begin
		  if (y_counter_max)
			...
			y_counter<=y_counter+1; // y_counterñşî¤x_counter?ì»y_counterÚ±??î¦Ê¥1
		end
